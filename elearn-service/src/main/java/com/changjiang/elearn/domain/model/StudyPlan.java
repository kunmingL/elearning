...
public class StudyPlan {
    ...
    @Builder
    public StudyPlan(String planId, String userId, Integer dailyWords, Integer totalDays, Integer totalWords, Integer currentDay, Integer status, Date createTime, Date updateTime) {
        this.planId = planId;
        this.userId = userId;
